...
double visualization_traj_width;  // 可视化轨迹宽度
double Vel, Acc;
...
int main(int argc, char **argv) 
{
    ...
    way_pts_sub = nh.subscribe("waypoints", 1, rcvWaypointsCallBack);                  // 订阅 waypoint_generator 发布的路径 nav_msgs::Path 型话题
